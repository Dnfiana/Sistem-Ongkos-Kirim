...
import 'package:out_box/app/modules/home/views/widgets/berat.dart';
...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('OutBox Express'),
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 1, 8, 98),
      ),
      body: SafeArea(
        child: ListView(
              ...
              () => controller.hiddenButton.isTrue
                  ...
                  : ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          primary: Color.fromARGB(255, 6, 2, 85)),
                    ),
            ),
          ],
        ),
